...
let ApiImpl = ApiImpl_1 = class ApiImpl {
    ...
    static getHeaders(options) {
        ...
        return Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, ip && {
            "x-forwarded-for": ip
        }), apiVersion && {
...
ApiImpl = ApiImpl_1 = __decorate([ injectable(), __param(0, inject(UrlBuilderService)), __param(1, inject(ApiOptionsToken)), __metadata("design:paramtypes", [ Object, Object ]) ], ApiImpl);
...
CmsImpl = __decorate([ injectable(), __param(0, inject(RpcClientService)), __param(1, inject(RpcServerService)), __param(2, inject(EventBusService)), __param(2, optional()), __metadata("design:paramtypes", [ Object, Object, Object ]) ], CmsImpl);
...
Cms14Impl = __decorate([ injectable(), __param(0, inject(EventBusService)), __param(0, optional()), __metadata("design:paramtypes", [ Object ]) ], Cms14Impl);
...
PostMessage = __decorate([ injectable(), __metadata("design:paramtypes", []) ], PostMessage);
...
ComponentImpl = __decorate([ injectable(), __param(0, inject(ComponentModelToken)), __param(1, inject(ComponentChildrenToken)), __param(2, inject(LinkFactory)), __param(3, inject(MetaCollectionFactory)), __metadata("design:paramtypes", [ Object, Array, LinkFactory, Function ]) ], ComponentImpl);
...
ComponentImpl$1 = __decorate([ injectable(), __param(0, inject(ComponentModelToken)), __param(1, inject(ComponentChildrenToken)), __param(2, inject(MetaCollectionFactory)), __param(3, inject(UrlBuilderService)), __metadata("design:paramtypes", [ Object, Array, Function, Object ]) ], ComponentImpl$1);
...
ContainerItemImpl = __decorate([ injectable(), __param(0, inject(ComponentModelToken)), __param(1, inject(LinkFactory)), __param(2, inject(MetaCollectionFactory)), __param(3, inject(EventBusService$1)), __param(3, optional()), __metadata("design:paramtypes", [ Object, LinkFactory, Function, Object ]) ], ContainerItemImpl);
...
ContainerItemImpl$1 = __decorate([ injectable(), __param(0, inject(ComponentModelToken)), __param(1, inject(MetaCollectionFactory)), __param(2, inject(UrlBuilderService)), __param(3, inject(EventBusService$1)), __param(3, optional()), __metadata("design:paramtypes", [ Object, Function, Object, Object ]) ], ContainerItemImpl$1);
...
ContentFactory = __decorate([ injectable() ], ContentFactory);
...
PageImpl = __decorate([ injectable(), __param(0, inject(PageModelToken)), __param(1, inject(ButtonFactory)), __param(2, inject(ComponentFactory)), __param(3, inject(ContentFactory)), __param(4, inject(LinkFactory)), __param(5, inject(LinkRewriterService)), __param(6, inject(MetaCollectionFactory)), __param(7, inject(EventBusService)), __param(7, optional()), __param(8, inject(EventBusService$1)), __param(8, optional()), __metadata("design:paramtypes", [ Object, ButtonFactory, ComponentFactory, ContentFactory, LinkFactory, Object, Function, Object, Object ]) ], PageImpl);
...
PageImpl$1 = PageImpl_1 = __decorate([ injectable(), __param(0, inject(PageModelToken)), __param(1, inject(ButtonFactory)), __param(2, inject(ComponentFactory$1)), __param(3, inject(ContentFactory$1)), __param(4, inject(LinkFactory)), __param(5, inject(LinkRewriterService)), __param(6, inject(MetaCollectionFactory)), __param(7, inject(EventBusService)), __param(7, optional()), __param(8, inject(EventBusService$1)), __param(8, optional()), __metadata("design:paramtypes", [ Object, ButtonFactory, ComponentFactory$1, Function, LinkFactory, Object, Function, Object, Object ]) ], PageImpl$1);
...
Spa = __decorate([ injectable(), __param(0, inject(ApiService)), __param(1, inject(PageFactory)), __param(2, inject(EventBusService)), __param(2, optional()), __param(3, inject(EventBusService$1)), __param(3, optional()), __metadata("design:paramtypes", [ Object, Function, Object, Object ]) ], Spa);
...
export { META_POSITION_BEGIN, META_POSITION_END, TYPE_CONTAINER_BOX, TYPE_CONTAINER_INLINE, TYPE_CONTAINER_NO_MARKUP, TYPE_CONTAINER_ORDERED_LIST, TYPE_CONTAINER_UNORDERED_LIST, TYPE_LINK_EXTERNAL, TYPE_LINK_INTERNAL, TYPE_LINK_RESOURCE, TYPE_MANAGE_CONTENT_BUTTON, TYPE_MANAGE_MENU_BUTTON, destroy, initialize, isComponent$2 as isComponent, isContainer$2 as isContainer, isContainerItem$2 as isContainerItem, isContent, isDocument, isImageSet, isLink, isMenu, isMeta, isMetaComment, isPage$2 as isPage, isPagination, isReference };
